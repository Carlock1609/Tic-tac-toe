...
class Game:
   ...
   def calc_winner(self, player, ls):
      ls.sort()
      if ls.__contains__(1) and ls.__contains__(2) and ls.__contains__(3):
         return True, player.name
      elif ls.__contains__(4) and ls.__contains__(5) and ls.__contains__(6):
         return True, player.name
      elif ls.__contains__(7) and ls.__contains__(8) and ls.__contains__(9):
         return True, player.name
      elif ls.__contains__(1) and ls.__contains__(4) and ls.__contains__(7):
         return True, player.name         
      elif ls.__contains__(2) and ls.__contains__(5) and ls.__contains__(8):
         return True, player.name
      elif ls.__contains__(3) and ls.__contains__(6) and ls.__contains__(9):
         return True, player.name
      elif ls.__contains__(1) and ls.__contains__(5) and ls.__contains__(9):
         return True, player.name
      elif ls.__contains__(3) and ls.__contains__(5) and ls.__contains__(7):
         return True, player.name
      else:
